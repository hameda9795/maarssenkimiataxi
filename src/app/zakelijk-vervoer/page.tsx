        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-4xl font-bold mb-6">Waarom Zakelijk Vervoer bij Ons?</h2>
          ...
          {/* Services */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold mb-8 text-center">Zakelijke Diensten</h2>
          ...
          <div className="glass-panel p-8 rounded-2xl mb-16">
            <h2 className="text-3xl font-bold mb-6 text-center">Voordelen voor Bedrijven</h2>
          ...
          {/* CTA */}
          <div className="glass-panel p-12 rounded-2xl text-center bg-gradient-to-br from-secondary/10 to-primary/10">
            <h2 className="text-4xl font-bold mb-4">Zakelijk Contract Afsluiten?</h2>
            <p className="text-xl text-gray-300 mb-8">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <a href="mailto:kimiataxi@maarssen.nl" className="glass-panel px-8 py-4 rounded-lg hover:bg-white/10 transition-colors text-lg font-semibold">
                ✉️ Email Ons
              </a>
            </div>
          </div>
